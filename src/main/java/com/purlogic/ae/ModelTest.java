...
import com.purlogic.ae.RandomGenerator.AttributeType;
import com.purlogic.ae.RandomGenerator.DistributionType;
...
public class ModelTest {
	...
	public static void main(String[] args) {
		System.out.println("This software generates random data models for AE");
